			...
			<article class="span-24">
				...
				<table>
					...
					foreach($posts as $post) {
						echo "<tr><td>";
						echo " <a href=\"".BASE_PATH."/admin/new_edit/post/".$post['post_id']."\"><img src=\"".BASE_PATH."/theme/admin/images/icons/pencil.png\"></a>";
						echo " <a href=\"".BASE_PATH."/admin/delete/post/".$post['post_id']."\" onclick=\"return confirm('Do you really want to delete this post?')\"><img src=\"".BASE_PATH."/theme/admin/images/icons/delete.png\"></a></td>";
