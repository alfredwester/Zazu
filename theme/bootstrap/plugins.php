		...
		<section>
			...
			<table class="table table-striped table-hover">
				...
				foreach($plugins as $plugin) {
					...
					echo "<tr class=\"clickable ".$tr_class."\" onclick=\"location.href='/admin/plugin/".$plugin_name."'\"><td>";
					if($this->permission_handler->has_permission('delete', 'plugin', $plugin_id)) {
						echo " <a href=\"".BASE_PATH."/plugin/delete/".$plugin_id."\" onclick=\"return confirm('Do you really want to delete this plugin?')\" title=\"Delete this plugin\"><i class=\"fa fa-trash-o\"></i></a>";
						$auth = true;
					}
					if($this->permission_handler->has_permission('uninstall', 'plugin', $plugin_name) && $plugin_installed) {
					...
					if($this->permission_handler->has_permission('install', 'plugin', $plugin_id) && !$plugin_installed) {
