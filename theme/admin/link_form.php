			<article class="span-24">
				<div class="span-20">
					<form action="<?php echo BASE_PATH;?>/admin/<?=$action;?>/link/<?=$link_id;?>" method="post">
						...
						<input type="text" class="text" id="link_title" value="<?=$link_title;?>" name="link_title"/><br>
						<label for="link_url">Link url</label><br>
						<input type="text" class="text" id="link_url" value="<?=$link_url;?>" name="link_url"/><br>
						<label for="link_group">Link group</label><br>
						<input type="text" class="text" id="link_group" value="<?=$link_group;?>" name="link_group"/><br>
						<label for="link_order">Link order</label><br>
						<input type="text" class="text" id="link_order" value="<?=$link_order;?>" name="link_order"/><br>
						<hr class="space"/>
						<div class="buttons">
