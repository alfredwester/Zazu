		...
		<section>
			<form action="<?php echo BASE_PATH;?>/admin/save_user_profile" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span3" id="user_password" required value="<?=$user_password;?>" name="user_password"/><span class="help-inline">(Showing encrypted password, change only if you want to change password)</span>
					</div>
				</div>
				<div class="control-group">
